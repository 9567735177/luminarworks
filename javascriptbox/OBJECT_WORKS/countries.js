...
for (let country of countries) {
  ...
  //console.log(`CountryName${countryName},population${population},capital${capitalName},currency${currency}`);



  let cntryData = {countryName,population,currency,capitalName}
  Mycountries.push(cntryData)
}

//console.log(Mycountries);
//find countryname from details...
//Mycountries.forEach(data=>console.log(data.countryName))
//
  //console.log(countries[0]);
  //console.log(countries.length);   //no of countries details

  //print details of india           //find
  let indiadetail=Mycountries.find(data=>data.countryName=="India")
  //console.log(indiadetail);
  //find currency of china               //find
  let chinacurrency=Mycountries.find(data=>data.countryName=="China").currency
  //console.log(chinacurrency);
  //countryname which have population above 2 crore
  Mycountries.filter(crore=>crore.population>20000000).
